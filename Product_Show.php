...
?>
	...
	?>
    <center><strong><a href="product_show.php">View All Products</a> Or Product Catagories</strong></center>
<div>
<center>
...
while($row = mysqli_fetch_array($result,MYSQL_BOTH)){
	...
	?>
		...
		<td align="center"><a href="product_detail.php?d_id=<?php echo $u_id; ?>"><?php echo $u_name; ?></a></td>
