<header class="full-width">
            <div id="header" class="full-width">
                <div id="logo" class="full-height"><a href="Home.php"></a></div>
                <div id="user-data" class="full-height">
                    <div>Welcome <?php if(isset($_SESSION['$name'])){echo $_SESSION['$name'];} ?></div>
                </div>
            ...
            <div id="header-menu-container">
                <ul>
                    ...
                    <li><a href="Product_User.php">Products</a></li>
                    <li><a href="About_us_User.php">About Us</a></li>
                    <li><a href="">Shopping Cart</a></li>
                    <li><a href="Contact_us_User.php">Contact Us</a></li>
                    <li><a href="view_my_products.php">My Account</a></li>
            ...
            <div id="header-banner" class="full-width">
                <div id="header-banner-text">
                    ...
                    <div id="browse-all-products"><a href="view_products_user.php">Browse All Products</a></div>
                </div>
