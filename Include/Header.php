<header class="full-width">
            <div id="header" class="full-width">
                ...
                <div id="top-header-right" class="full-height">
                    <div id="top-header-right-top" class="full-width"><a href="login.php">Login</a> | <a href="Sign_up.php">Signup</a></div>
            ...
            <div id="header-banner" class="full-width">
                <div id="header-banner-text">
                    ...
                    <div id="browse-all-products"><a href="Product.php">Browse All Products</a></div>
                </div>
